...
Golang anonymous is more powerful than python anonymous functions. python anonymous functions supports only single line statements.
...
Python is definitely preferred in Data analytics/Data scientist/Machine learning areas and Web application development through mature frameworks like django and flask.
...
func emptyInterface() {
	...
	//Type assertion - Type assertion access data as particular data type from the empty interface{}
	var T interface{}
	T = 10
	T = "stringValue"
	T = sample{}
